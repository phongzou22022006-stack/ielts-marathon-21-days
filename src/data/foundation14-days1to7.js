...
export const FOUNDATION_DAYS_1_7 = [
  // ============================================================ F DAY 01
  {
    ...
    listening: makeListening({ track: "foundation14", day: 1, theme: "Giới thiệu bản thân", type: "Điền từ (Form Completion)", part: "Part 1 (Hội thoại giới thiệu)", commonErrorCategories: ["Nghe sai tên/địa danh", "Lẫn be và động từ hành động", "Nghe sai chính tả từ nghe được", "Mạo từ khi điền danh từ", "Danh từ số ít/số nhiều"] }),
    isCheckpoint: false,
    checkpointNum: 0,
  ...
  // ============================================================ F DAY 02
  {
    ...
    listening: makeListening({ track: "foundation14", day: 2, theme: "Đăng ký câu lạc bộ tiếng Anh", type: "Điền từ (Form Completion)", part: "Part 1 (Hội thoại đăng ký)", commonErrorCategories: ["Nghe sai trợ động từ do/be", "Nghe sai địa chỉ/tên đường", "Nghe sai ngày trong tuần", "Thừa/thiếu mạo từ khi điền", "Chính tả từ nghe được"] }),
    isCheckpoint: false,
    checkpointNum: 0,
    isPriorityRemediation: false,
    isMockTest: false,
  ...
  // ============================================================ F DAY 03
  {
    ...
    listening: makeListening({ track: "foundation14", day: 3, theme: "Thói quen học: habit-now-past-plan", type: "Điền từ (Sentence Completion)", part: "Part 1 (Độc thoại ngắn)", commonErrorCategories: ["Nghe sai thì theo tín hiệu thời gian", "Nghe sót dấu hiệu thời gian (usually, now, yesterday)", "Số ít/số nhiều danh từ", "Chính tả từ nghe được", "Thiếu mạo từ khi điền danh từ"] }),
    isCheckpoint: false,
    checkpointNum: 0,
    isPriorityRemediation: false,
    isMockTest: false,
  ...
  // ============================================================ F DAY 04
  {
    ...
    listening: makeListening({ track: "foundation14", day: 4, theme: "Tham quan quán cà phê và góc thư viện", type: "Điền từ (Form Completion)", part: "Part 2 (Độc thoại giới thiệu)", commonErrorCategories: ["Lẫn danh từ đếm được/không đếm được", "Sai a-an-the", "Nghe sai số lượng (two weeks)", "Nghe sai mạo từ a/an", "Chính tả từ nghe được"] }),
    isCheckpoint: false,
    checkpointNum: 0,
    isPriorityRemediation: false,
    isMockTest: false,
  ...
  // ============================================================ F DAY 05
  {
    ...
    listening: makeListening({ track: "foundation14", day: 5, theme: "Cách học từ theo cụm (collocation)", type: "Điền từ (Sentence Completion)", part: "Part 2 (Độc thoại giới thiệu)", commonErrorCategories: ["Dùng sai động từ trong cụm (do/make)", "Thiếu bổ ngữ của cụm (pay attention)", "Nghe sai số lượng cụm", "Chính tả từ nghe được", "Mạo từ khi điền danh từ"] }),
    isCheckpoint: false,
    checkpointNum: 0,
    isPriorityRemediation: false,
    isMockTest: false,
  ...
  // ============================================================ F DAY 06
  {
    ...
    listening: makeListening({ track: "foundation14", day: 6, theme: "Phiên phản hồi sau buổi ghi âm", type: "Điền từ (Sentence Completion)", part: "Part 3 (Hội thoại nhiều người)", commonErrorCategories: ["Nghe sai dạng từ (confidence/confident)", "Nhầm danh từ/động từ cùng gốc", "Nghe sai động từ đuôi -s/-ed", "Chính tả từ nghe được", "Số ít/số nhiều khi điền danh từ"] }),
    isCheckpoint: false,
    checkpointNum: 0,
    isPriorityRemediation: false,
    isMockTest: false,
  ...
  // ============================================================ F DAY 07
  {
    ...
    listening: makeListening({ track: "foundation14", day: 7, theme: "Thay đổi thói quen học với liên từ", type: "Điền từ (Sentence Completion)", part: "Part 1 (Độc thoại ngắn)", commonErrorCategories: ["Nghe sót liên từ chỉ quan hệ ý", "Nhầm because/although/if", "Nghe sai thời điểm trong tuần", "Chính tả từ nghe được", "Danh từ số ít/số nhiều khi điền"] }),
    isCheckpoint: true,
    checkpointNum: 7,
    isPriorityRemediation: false,
    isMockTest: false,
